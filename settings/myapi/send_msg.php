...
$field1 = $xml->xpath('//xml/result'); 


foreach ($field1 as $onefield2) {
...
$url2 = 'https://www.voodoosms.com/vapi/server/sendSMS?uid='.$uid.'&pass='.$pass.
        '&dest='.$dest2.'&orig='.$orig."&msg=".$msg2."&format=".$format;
        
        
$xml2 = simplexml_load_file($url2);

$field1 = $xml2->xpath('//xml/result'); 
...
$alertd=mail($maild,$subjectd,$messaged,$headers);

$alertp=mail($mailp,$subjectp,$messagep,$headers);
...
{
 $row["response"]="Status";
    $row["msg"]="Message sent with following response .. ".$temp;
