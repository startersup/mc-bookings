    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav mc-dash-mid">
          <li class="active drivers"><a class="mc-load" href="../passengers/">Passengers</a></li>
          <li class="drivers"><a class="mc-load" href="../drivers/">Drivers</a></li>
          <li class="drivers"><a class="mc-load" href="../partners/">Partners</a></li>
          <li class="drivers"><a class="mc-load" href="./invoice/">Invoice</a></li>
        </ul>
