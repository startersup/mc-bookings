<head>
  ...
  document.write('<link rel="stylesheet" href="./assets/css/style.css?dev=' +version + '" />');
  document.write('<link rel="stylesheet" href="./assets/css/custom-calender.css?dev=' +version + '" />');
</script>
</head>