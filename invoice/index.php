 ...
 <div class="mc-sub-section">
                      ...
                      <tr>
                        <td class="title"
                          ...
                          <img id="minicabee_show" src="https://minicabee.co.uk/assets/images/logo.png"
                            ...
                            <img id="taxicode_show" src="https://bookings.minicabee.co.uk/assets/images/britannia.jpg"
                            style="width:100%; max-width:200px !important;">
                            <!-- <a class="navbar-brand" href="/" id=""><span>Britannia</span> Cars</a> -->
                        </td>
  ...
  overflow-y: scroll;">
    ...
    <div id="emptyPreview" class="empty_states" style="display:block">
     <center> <img class="empty_image" src="../assets/images/empty-states/mc_empty_states.png"></center>
      <p style="text-align:center;font-family:'montserrat',sans-serif;">Sorry No Preview Available</p>
    </div>
